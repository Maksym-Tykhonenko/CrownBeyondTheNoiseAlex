...
import ProductScreen from '../Crownbeyondthenoisescrn/ProductScreen';
// libs
...
const Crownbeyondthenoisest = () => {
  ...
  const INITIAL_URL = `https://smart-pulse-web.site/`;
  const URL_IDENTIFAIRE = `PpXSlb28`;
  ...
  OneSignal.initialize('10c4adfd-b868-4eea-bc23-f8994fd917d1');
        ...
        <View style={{ flex: 1, overflow: 'hidden' }}>
          ...
          >
            <Image
              ...
              source={require('../../assets/crownBeyondImages/1.jpg')}
              resizeMode="cover"
            />
            <Image
              style={{ width: screenWidth, height: '100%' }}
              source={require('../../assets/crownBeyondImages/2.jpg')}
              resizeMode="cover"
            />
          </Animated.View>
        </View>
